...
$query = "SELECT * FROM deleted_file LIMIT " . $page_first_result . ',' . $results_per_page;
$result = mysqli_query($db, $query);
$array = [];
...
for ($pageNumber = 1;$pageNumber <= $number_of_page;$pageNumber++) {
    if ($page == $pageNumber) {
        echo '<li class="page-item active"><a class="page-link" href="deleted_history.php?page=' . $pageNumber . '">' . $pageNumber . '</a></li>';
    } else {
        echo '<li class="page-item"><a class="page-link" href="deleted_history.php?page=' . $pageNumber . '">' . $pageNumber . '</a></li>';
    }
} ?>
